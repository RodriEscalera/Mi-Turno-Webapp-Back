...
exports.getScheduleOfBooking =
  exports.getSoldOutBookingPerMonth =
  exports.deleteBooking =
  exports.updateBooking =
  exports.getLastBooking =
  exports.createBooking =
  exports.getBookingOfUser =
  exports.getAllBookings =
  exports.getOneBooking =
    void 0;
...
const getBookingOfUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const idUser = req.params.user;
      const turnos = yield Booking_1.default
        .find({ user: idUser })
        .populate("branch");
...
const getLastBooking = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { userId } = req.params;
      const bookings = yield Booking_1.default
        .find({ user: userId })
        .sort({
          createdAt: "desc",
        })
...
const getSoldOutBookingPerMonth = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getScheduleOfBooking = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { date, branch } = req.body;
